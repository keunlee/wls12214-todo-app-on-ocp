...
<body>
<div style="position: absolute; top: 0px; left: 0px;"><img style="width: 50px;margin: 10px;" src="static/logo.png"></div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            completeTodo: function(todo) {
                fetch(API + '/' + todo.id, {headers: HEADERS, method: "PUT",
                    body: JSON.stringify({
                        title: todo.title,
                        id: todo.id,
            ...
            completeAll: function() {
                this.todos.forEach(t => {
                    fetch(API + '/' + t.id, {headers: HEADERS, method: "PUT",
                        body: JSON.stringify({
                            title: t.title,
                            id: t.id,
            ...
            removeTodo: function (todo) {
                fetch(API + '/' + todo.id, {headers: HEADERS, method: "DELETE"}).
                then(res => {
                    if (res.ok) {
